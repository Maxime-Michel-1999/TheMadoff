...
import MadoffNFT from '../contracts/ethereum-contracts/BoredPetsNFT.json'
...
export default function CreateItem() {
  ...
  async function listNFTForSale() {
    ...
    // Mint the NFT
    const boredPetsContractAddress = MadoffNFT.networks[networkId].address
    const boredPetsContract = new web3.eth.Contract(MadoffNFT.abi, boredPetsContractAddress)
